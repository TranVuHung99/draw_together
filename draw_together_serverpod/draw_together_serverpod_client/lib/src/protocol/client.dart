...
/// {@category Endpoint}
class EndpointGameStreaming extends _i2.EndpointRef {
  EndpointGameStreaming(_i2.EndpointCaller caller) : super(caller);
...
class EndpointRoom extends _i2.EndpointRef {
  ...
  _i3.Future<_i6.Player?> joinRoom(
    String roomCode,
    String playerName,
  ) => caller.callServerEndpoint<_i6.Player?>(
    'room',
    'joinRoom',
    {
      'roomCode': roomCode,
  ...
  /// Get player by ID
  _i3.Future<_i6.Player?> getPlayer(int playerId) =>
      caller.callServerEndpoint<_i6.Player?>(
        'room',
        'getPlayer',
        {'playerId': playerId},
  ...
  /// Get room by ID
  _i3.Future<_i5.Room?> getRoom(int roomId) =>
      caller.callServerEndpoint<_i5.Room?>(
        'room',
        'getRoom',
        {'roomId': roomId},
  ...
  _i3.Future<List<_i6.Player>> getPlayersInRoom(int roomId) =>
...
class Client extends _i2.ServerpodClientShared {
  Client(
    ...
    gameStreaming = EndpointGameStreaming(this);
  ...
  late final EndpointGameStreaming gameStreaming;
