...
class TestEndpoints {
  ...
  late final _GameStreamingEndpoint gameStreaming;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    gameStreaming = _GameStreamingEndpoint(
      endpoints,
      serializationManager,
    );
    room = _RoomEndpoint(
...
class _GameStreamingEndpoint {
  _GameStreamingEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Stream<_i2.SerializableModel> live(
    ...
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
              endpoint: 'gameStreaming',
              method: 'live',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'gameStreaming',
              methodName: 'live',
              arguments: {},
              requestedInputStreams: ['incomingStream'],
              serializationManager: _serializationManager,
            );
...
class _RoomEndpoint {
  ...
  _i3.Future<_i5.Room?> createRoom(
    _i1.TestSessionBuilder sessionBuilder,
    String hostName,
    double canvasWidth,
    double canvasHeight,
  ...
  _i3.Future<_i6.Player?> joinRoom(
    _i1.TestSessionBuilder sessionBuilder,
    String roomCode,
    String playerName,
  ) async {
  ...
  _i3.Future<_i6.Player?> getPlayer(
    _i1.TestSessionBuilder sessionBuilder,
    int playerId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'playerId': playerId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i6.Player>> getPlayersInRoom(
    _i1.TestSessionBuilder sessionBuilder,
    int roomId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'room',
            method: 'getPlayersInRoom',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'room',
          methodName: 'getPlayersInRoom',
          parameters: _i1.testObjectToJson({'roomId': roomId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _GameEndFutureCall {
  Future<void> finalizeRoom(
    ...
    var object = _i8.GameEndFutureCallFinalizeRoomModel(roomId: roomId);
    var _localUniqueSession = (sessionBuilder as _i1.InternalTestSessionBuilder)
        .internalBuild();
    try {
      await _i9.GameEndFinalizeRoomFutureCall().invoke(
        _localUniqueSession,
        object,
      );
    } finally {
